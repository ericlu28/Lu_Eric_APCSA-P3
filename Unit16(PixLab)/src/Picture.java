...
public class Picture extends SimplePicture 
{
  ...
  /** mirrors horizontal bottom to top (one line change) **/
  ...
  /** method to mirror the gull on the beach **/
