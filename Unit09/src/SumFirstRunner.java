...
public class SumFirstRunner
{
	public static void main( String args[] )
	{
		...
		ArrayList <Integer> list1 = new ArrayList<Integer>(Arrays.asList(10,9,8,7,6,5,4,3,3,2,1,-99));
		...
		ArrayList <Integer> list5 = new ArrayList<Integer>(Arrays.asList(9,10,-88,100,-555,2));
		...
		ArrayList <Integer> list7 = new ArrayList<Integer>(Arrays.asList(-111,1,2,3,9,11,20,1));
		System.out.println(test.go(list7));
		ArrayList <Integer> list8 = new ArrayList<Integer>(Arrays.asList(9,8,7,6,5,4,3,2,0,-2,6));
